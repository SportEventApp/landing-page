# tournoidevincennes [![Build Status](https://travis-ci.org/SportEventApp/landing-page.svg?branch=master)](https://travis-ci.org/SportEventApp/landing-page)
...
To optimize the tournoidevincennes application for production, run:
